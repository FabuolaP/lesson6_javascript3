...
function createEventListeners() {
   ...
   //the leftArrow() function wil be executed when the user clicks the left navigation arrow buttion
   ...
   rightarrow.addEventListener("click", rightArrow, false);
    ...
    //declare a variable for the element fiveButoon
